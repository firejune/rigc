...
### The texture floor — `--texture-from`, a named diagnostic and not the record

| set | MAE | texture floor | above it | share of the figure |
| --- | ---: | ---: | ---: | ---: |
| `aim` | 45.09 | 7.01 | 42.83 | 5.0% |
| `aim@30fps` | 45.09 | 7.01 | 42.83 | 5.0% |
| `death` | 63.55 | 6.71 | 61.63 | 3.0% |
| `death@30fps` | 69.73 | 5.85 | 68.06 | 2.4% |
| `hit` | 60.30 | 6.60 | 58.28 | 3.3% |
| `hit@30fps` | 53.98 | 6.86 | 51.70 | 4.2% |
| `idle` | 49.59 | 6.97 | 47.19 | 4.8% |
| `idle@30fps` | 49.00 | 6.83 | 46.76 | 4.6% |
| `jump` | 48.95 | 6.69 | 46.60 | 4.8% |
| `jump@30fps` | 50.97 | 6.99 | 48.46 | 4.9% |
| `run` | 51.99 | 6.73 | 49.79 | 4.2% |
| `run@30fps` | 54.25 | 6.27 | 52.12 | 3.9% |
| `shoot` | 42.70 | 5.48 | 40.88 | 4.3% |
| `shoot@30fps` | 44.00 | 6.93 | 41.65 | 5.3% |
| `walk` | 41.21 | 6.97 | 38.74 | 6.0% |
| `walk@30fps` | 47.53 | 6.98 | 45.40 | 4.5% |
