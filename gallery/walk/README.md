...
..    47 assertions: 14 measured (14 passed, 0 failed), 18 skipped, 15 not in profile "spine"
```
...
..    47 assertions: 20 measured (20 passed, 0 failed), 27 skipped, 0 not in profile "spine-html"
```
